        ...
        if (areaNum == 1) {
            ...
            if (y <= 6) {
                if (x <= 6) {
                    ...
                    System.out.println("There is a curtain to the east of you. There is also a door on the south side of the room.");
                }
            } else if (y < 15 && x <= 3) {
                ...
                System.out.println("The passage you ae in has a door on it's left side (east).");
